...
def extract_text(image, bbox):
    ...
    if 0 in roi.shape:
        ...
        text = pytesseract.image_to_string(magic_color, config='-c tessedit_char_whitelist=abcdefghijklmnopqrstuvwxyz0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ --psm 8 --oem 3')
        text = text.strip()
...
# Example Usage
# path_to_image = "/content/26.png"
# filename = "output.png"
# text_list = object_detection(path_to_image, filename)
# print("Detected Text:", text_list)
